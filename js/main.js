...
function printFormattedTable(){
	...
	var game1Winner = $("#GameOne .Winner").val();
	...
	var game2Winner = $("#GameTwo .Winner").val();
	...
	var game3Winner = $("#GameThree .Winner").val();
	...
	var game4Winner = $("#GameFour .Winner").val();
	...
	var game5Winner = $("#GameFive .Winner").val();
